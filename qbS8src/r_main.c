...
cvar_t	r_stereo_separation = {"r_stereo_separation","0", true}; // Manoel Kasimier - stereo 3D
cvar_t	r_shadowhack = {"r_shadowhack", "0", false};
cvar_t	r_shadowhacksize = {"r_shadowhacksize", "2.7", true};

int		r_stereo_side; // Manoel Kasimier - stereo 3D
...
//	Cvar_RegisterVariableWithCallback (&r_letterbox, SCR_Adjust); // Manoel Kasimier - r_letterbox
    ...
    Cvar_RegisterVariable (&r_stereo_separation); // Manoel Kasimier - stereo 3D
...
void R_SetVrect (vrect_t *pvrectin, vrect_t *pvrect, int lineadj)
{
    ...
    // Manoel Kasimier - split screen - begin
    /*
    // this is just a hack
    if (temp1.value == 1)
    {
    ...
    */
    // Manoel Kasimier - split screen - end
