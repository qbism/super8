...
//qbism- zone gone per mh idea... #define	DYNAMIC_SIZE	256*1024		// qbism 256k, was 48k
...
void *Q_calloc (size_t n)
{
   ...
   if (!(p = calloc(n, 1)))  //qbism- always 1 !
